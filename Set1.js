...
let TaxLoss = Math.floor(grossPay * taxRate);
let postTaxPay = grossPay - TaxLoss;
let finalAmount =  postTaxPay - expenses;
return finalAmount;
}
...
let product = numJobs * jobConsumption;
let finalMaterial = totalMaterial - product;
return finalMaterial + materialUnits;
}
...
let sampleInterest = rate * principal * periods;
let finalValue = principal + sampleInterest;
